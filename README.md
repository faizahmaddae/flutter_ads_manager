...
**Author:** [@faizahmaddae](https://github.com/faizahmaddae) reusable ads management library for Flutter that integrates Google Mobile Ads (AdMob) with GDPR‑compliant consent handling. It supports adaptive **banner ads**, **collapsible## Contributing
